function Slide({
  ...
  return (
    <>
      ...
      >
        <img src={SrcImg} alt={AltImg} draggable="false" className={`no-drag w-full no-drag ${Add_Style_Img}`} />
        <h2 className="text-white text-xl font-semibold m-0.5 mb-2 ">
          {TitleSlide}
        </h2>
        <p
          className={`text-white/80 text-sm m-0.5 mb-5 break-words ${Add_Style_TextSlide}`}
        >
          {TextSlide}
        </p>
